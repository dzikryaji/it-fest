package com.mobile.itfest.ui.oldMain
...
import com.mobile.itfest.databinding.ActivityOldMainBinding
    ...
    private fun setListener() {
        binding.apply {
            btnLogout.setOnClickListener {
                viewModel.logout()
                val intent = Intent(this@OldMainActivity, LoginActivity::class.java)
                startActivity(intent)
                finish()
            }
